...
\codetexSpace{0} public class InputFile $\{$\codetexNewline
\codetexSpace{4} Logger logger = Logger.getLogger("InputFile");\codetexNewline
\codetexSpace{4} final static Charset ENCODING = StandardCharsets.UTF\_8;\codetexNewline
\codetexSpace{4} \codetexNewline
\codetexSpace{4} private String fileName = "";\codetexNewline
\codetexSpace{4} private Path path;\codetexNewline
\codetexSpace{4} private BufferedReader reader = null;\codetexNewline
\codetexSpace{4} private boolean end = false;\codetexNewline
\codetexSpace{4} \codetexNewline
\codetexSpace{4} public InputFile(String fileName) throws IOException $\{$\codetexNewline
\codetexSpace{8} logger.debug("Openning file in constructor...");\codetexNewline
\codetexSpace{8} this.fileName = fileName;\codetexNewline
\codetexSpace{8} this.path=Paths.get(this.fileName);\codetexNewline
\codetexSpace{8} reader=Files.newBufferedReader( path, ENCODING );\codetexNewline
\codetexSpace{8} $\}$\codetexNewline
\codetexSpace{4} \codetexNewline
\codetexSpace{4} /**\codetexNewline
\codetexSpace{4} * Read one line from file.\codetexNewline
\codetexSpace{4} *\codetexNewline
\codetexSpace{4} * @return String filled with one line.\codetexNewline
\codetexSpace{4} */\codetexNewline
\codetexSpace{4} public String readLine() $\{$\codetexNewline
\codetexSpace{8} logger.debug("Reading line. End=" + end);\codetexNewline
\codetexSpace{8} String line = null;\codetexNewline
\codetexSpace{8} \codetexNewline
\codetexSpace{8} try $\{$\codetexNewline
\codetexSpace{12} if (!end) $\{$\codetexNewline
\codetexSpace{16} line = reader.readLine();\codetexNewline
\codetexSpace{16} $\}$\codetexNewline
\codetexSpace{12} $\}$ catch (IOException e) $\{$\codetexNewline
\codetexSpace{12} logger.error("Could not read line. " + e);\codetexNewline
\codetexSpace{12} e.printStackTrace();\codetexNewline
...
\codetexSpace{12} $\}$\codetexNewline
\codetexSpace{8} \codetexNewline
\codetexSpace{8} return line;\codetexNewline
\codetexSpace{8} $\}$\codetexNewline
\codetexSpace{4} $\}$\codetexNewline
